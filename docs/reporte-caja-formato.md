...
El conteo centra los valores de la columna **Efectivo** y deja vacíos los valores cero. Los totales de billetes y monedas se muestran en una tabla de dos filas con bordes, como el escritorio. Las columnas de descripción, incluido su encabezado en el resumen de ventas, se alinean a la izquierda.
