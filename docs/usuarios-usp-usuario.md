...
El formulario reutiliza `UserFormBase` y conserva los campos de serie, permisos de comprobantes, administrador, rutas y vencimiento de clave. La clave se cifra con `dbo.encriptar` antes de enviarse al parámetro `@UsuarioClave` del procedimiento.
